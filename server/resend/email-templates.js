...
const welcomeUserMsg = process.env.WELCOME_USER_MSG;
const projectUrl = process.env.CLIENT_URL;
  ...
  <body style="background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,Oxygen-Sans,Ubuntu,Cantarell,&quot;Helvetica Neue&quot;,sans-serif">
    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="max-width:37.5em;margin:0 auto;padding:20px 0 48px">
      <tbody>
        <tr style="width:100%">
          <td>
        <h5 style="color: #fff;background: linear-gradient(to right, rgb(76, 175, 80), rgb(69, 160, 73));text-align: center;font-size: 25px;font-weight: 400;padding: 10px 0;">${projectName}</h5>
            <p style="font-size:16px;line-height:26px;margin:16px 0">Hi <!-- -->{name}<!-- -->,</p>
            <p style="font-size:16px;line-height:26px;margin:16px 0">${welcomeUserMsg}</p>
            ...
            <p style="font-size:16px;line-height:26px;margin:16px 0">Best,<br />The ${projectName} team</p>
            <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#cccccc;margin:20px 0" />
            <p style="font-size:12px;line-height:24px;margin:16px 0;color:#8898aa;text-align: center;">Lebanon-Beirut</p>
          </td>
        </tr>
      </tbody>
    </table><!--/$-->
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Best regards,<br>${projectName} Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
